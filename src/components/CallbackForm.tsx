      ...
      const onSubmit = async (data: FormValues) => {
        ...
        try {
          ...
          const response = await fetch(
            "https://script.google.com/macros/s/AKfycbxN9xWz0wO4Y97WDBc1tX_CvIjhRYDVd9-ZITUyeSwlwbmkcwVBsiha-5WcWUJz-Vp0Zg/exec",
            {
              method: "POST",
              headers: {
          ...
          console.log("Response text:", await response.text()); // Log raw response
